...
var AbstractConsentHandler = /** @class */ (function () {
    function AbstractConsentHandler() {
        ...
        this.currentNecessaryConsent = new BehaviorSubject(initialConsent.necessary || 'denied');
        this.currentFunctionalConsent = new BehaviorSubject(initialConsent.functional || 'denied');
        this.currentAnalyticsConsent = new BehaviorSubject(initialConsent.analytics || 'denied');
        this.currentPerformanceConsent = new BehaviorSubject(initialConsent.performance || 'denied');
        this.currentMarketingConsent = new BehaviorSubject(initialConsent.marketing || 'denied');
        ...
        ]).pipe(debounceTime(1), map(function (_a) {
            var necessary = _a[0], functional = _a[1], analytics = _a[2], performance = _a[3], marketing = _a[4];
            return {
                consent: {
                    necessary: necessary,
                ...
                handler: _this.getConsentHandlerName(),
            };
        }));
    }
...
var cookie_yes_consent_handler_extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
            function (d, b) { for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p]; };
...
var CookieYesConsentHandler = /** @class */ (function (_super) {
    cookie_yes_consent_handler_extends(CookieYesConsentHandler, _super);
